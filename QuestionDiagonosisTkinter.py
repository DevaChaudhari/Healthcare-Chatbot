...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Devendra Chaudhari", bg="RoyalBlue1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Caleb Dmello", bg="RoyalBlue2", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Avantika Shedge", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam4 = Label(self, text="Dhaneshree Shinde", bg="RoyalBlue3", width="250", height="1",font=("Calibri", 13))
        self.lblTeam4.pack()
        self.lblTeam5 = Label(self, text="Abhishek Choudhary", bg="RoyalBlue3", width="250", height="1",font=("Calibri", 13))
        self.lblTeam5.pack()
